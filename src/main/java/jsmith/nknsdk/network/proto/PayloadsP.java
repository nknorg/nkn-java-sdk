...
public final class PayloadsP {
  ...
  public enum PayloadType
    ...
    public static final com.google.protobuf.Descriptors.EnumDescriptor
        getDescriptor() {
      return PayloadsP.getDescriptor().getEnumTypes().get(0);
    }
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return PayloadsP.internal_static_jsmith_nknsdk_network_proto_Payload_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return PayloadsP.internal_static_jsmith_nknsdk_network_proto_Payload_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              PayloadsP.Payload.class, PayloadsP.Payload.Builder.class);
    }
     ...
     * <code>.jsmith.nknsdk.network.proto.PayloadType type = 1;</code>
     */
    public PayloadsP.PayloadType getType() {
      @SuppressWarnings("deprecation")
      PayloadsP.PayloadType result = PayloadsP.PayloadType.valueOf(type_);
      return result == null ? PayloadsP.PayloadType.UNRECOGNIZED : result;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (type_ != PayloadsP.PayloadType.BINARY.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof PayloadsP.Payload)) {
        return super.equals(obj);
      }
      PayloadsP.Payload other = (PayloadsP.Payload) obj;
    ...
    public static PayloadsP.Payload parseFrom(
    ...
    public static PayloadsP.Payload parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static PayloadsP.Payload parseFrom(
    ...
    public static PayloadsP.Payload parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static PayloadsP.Payload parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static PayloadsP.Payload parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(PayloadsP.Payload prototype) {
    ...
    public static final class Builder extends
      ...
      @java.lang.Override
      public PayloadsP.Payload getDefaultInstanceForType() {
        return PayloadsP.Payload.getDefaultInstance();
      }

      @java.lang.Override
      public PayloadsP.Payload build() {
        PayloadsP.Payload result = buildPartial();
      ...
      @java.lang.Override
      public PayloadsP.Payload buildPartial() {
        PayloadsP.Payload result = new PayloadsP.Payload(this);
        result.type_ = type_;
        result.pid_ = pid_;
        result.data_ = data_;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof PayloadsP.Payload) {
          return mergeFrom((PayloadsP.Payload)other);
        } else {
      ...
      public Builder mergeFrom(PayloadsP.Payload other) {
        if (other == PayloadsP.Payload.getDefaultInstance()) return this;
        if (other.type_ != 0) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        PayloadsP.Payload parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (PayloadsP.Payload) e.getUnfinishedMessage();
       ...
       * <code>.jsmith.nknsdk.network.proto.PayloadType type = 1;</code>
       */
      public Builder setType(PayloadsP.PayloadType value) {
        if (value == null) {
    ...
    private static final PayloadsP.Payload DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new PayloadsP.Payload();
    }

    public static PayloadsP.Payload getDefaultInstance() {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return PayloadsP.internal_static_jsmith_nknsdk_network_proto_TextData_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return PayloadsP.internal_static_jsmith_nknsdk_network_proto_TextData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              PayloadsP.TextData.class, PayloadsP.TextData.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof PayloadsP.TextData)) {
        return super.equals(obj);
      }
      PayloadsP.TextData other = (PayloadsP.TextData) obj;
    ...
    public static PayloadsP.TextData parseFrom(
        java.nio.ByteBuffer data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static PayloadsP.TextData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static PayloadsP.TextData parseFrom(
    ...
    public static PayloadsP.TextData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input);
    }
    ...
    public static PayloadsP.TextData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static PayloadsP.TextData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(PayloadsP.TextData prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    @java.lang.Override
    public Builder toBuilder() {
    ...
    public static final class Builder extends
      ...
      @java.lang.Override
      public PayloadsP.TextData getDefaultInstanceForType() {
        return PayloadsP.TextData.getDefaultInstance();
      }

      @java.lang.Override
      public PayloadsP.TextData build() {
        PayloadsP.TextData result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      @java.lang.Override
      public PayloadsP.TextData buildPartial() {
        PayloadsP.TextData result = new PayloadsP.TextData(this);
        result.text_ = text_;
        onBuilt();
        return result;
      }
      ...
      @java.lang.Override
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof PayloadsP.TextData) {
          return mergeFrom((PayloadsP.TextData)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(PayloadsP.TextData other) {
        if (other == PayloadsP.TextData.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        PayloadsP.TextData parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (PayloadsP.TextData) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final PayloadsP.TextData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new PayloadsP.TextData();
    }

    public static PayloadsP.TextData getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }
